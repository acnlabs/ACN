...
acn_client = A2AClient(
    ...
    url="https://api.acnlabs.dev/a2a/jsonrpc"
)
...
const acnClient = new A2AClient('https://api.acnlabs.dev/a2a/jsonrpc');
...
```bash
curl https://api.acnlabs.dev/.well-known/agent-card.json
```
