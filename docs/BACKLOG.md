...
- **Negative coverage** for the not-yet-migrated `onchain` router
  (sprint #7, sampled as the representative pending router after
  #9 analytics landed) pinning the contract that it does *not*
...
#11 websocket): each PR should include a
