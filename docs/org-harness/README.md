...
| **[clawteam-loop-adapter-poc-v0.md](./clawteam-loop-adapter-poc-v0.md)** | **Agent-native Loop POC 选型（ClawTeam 侧车；未开工）** |
...
- **实验（选型中）：** [clawteam-loop-adapter-poc-v0.md](./clawteam-loop-adapter-poc-v0.md) — agent-native Loop 侧车；**确认前不写代码**。  
